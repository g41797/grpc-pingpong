...
func (c *pingPongClient) Play(ctx context.Context, in *Ball, opts ...grpc.CallOption) (*Ball, error) {
	out := new(Ball)
	err := c.cc.Invoke(ctx, PingPong_Play_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPingPongServer) Play(context.Context, *Ball) (*Ball, error) {
...
func _PingPong_Play_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PingPong_Play_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingPongServer).Play(ctx, req.(*Ball))
	}
