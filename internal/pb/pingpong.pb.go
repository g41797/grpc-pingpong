...
type Ball struct {
	...
	Metas  []*Ball_Meta `protobuf:"bytes,2,rep,name=Metas,proto3" json:"Metas,omitempty"`
...
func (x *Ball) GetMetas() []*Ball_Meta {
	if x != nil {
		return x.Metas
	}
	return nil
...
func (x *Ball_Meta) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Ball_Meta) ProtoMessage() {}

func (x *Ball_Meta) ProtoReflect() protoreflect.Message {
	mi := &file_pingpong_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Ball_Meta.ProtoReflect.Descriptor instead.
func (*Ball_Meta) Descriptor() ([]byte, []int) {
	return file_pingpong_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Ball_Meta) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *Ball_Meta) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
var file_pingpong_proto_rawDesc = []byte{
	...
	,
}
...
var file_pingpong_proto_goTypes = []interface{}{
	(*Ball)(nil),      // 0: pb.Ball
	(*Ball_Meta)(nil), // 1: pb.Ball.Meta
}
var file_pingpong_proto_depIdxs = []int32{
	1, // 0: pb.Ball.Metas:type_name -> pb.Ball.Meta
